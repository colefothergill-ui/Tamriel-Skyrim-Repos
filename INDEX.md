...
### Five Acts Structure
- **/modules/** — Act modules (to be created):
  - `act_01_whiterun_decision.md` — Neutrality breaks; Whiterun chooses a side
  - `act_02_fronts_shift.md` — War escalates across holds
  - `act_03_city_crisis_wave.md` — Urban crises and conspiracy threads
  - `act_04_siege_preparation.md` — Preparation for final sieges (Solitude/Windhelm)
  - `act_05_true_enemy.md` — Thalmor endgame revealed and confronted

### Side Plot Factions (Side Plot C)
- **/factions/** — Faction packs (to be created):
  - **Thieves Guild** — Shadows of the Rift (restoration arc)
  - **Dark Brotherhood** — Emperor assassination plot intersects the war
  - **College of Winterhold** — Eye of Magnus crisis and political fallout
  - **Companions** — Honor vs wartime brutality
  - **Forsworn** — Reach destabilization and independence struggle
  - **Thalmor** — Shadow war escalating into Act V
  - **Way of the Voice Offshoot** — Custom faction: Greybeards-adjacent splinter group
